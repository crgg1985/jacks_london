...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li><a href="#"><i class="icon-dashboard icon-2x"></i> Tablero </a></li> 
				...
				<li class="active"><a href="collection.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Reportes Generados</a>                     </li>
				<li><a href="accountreceivables.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Informe Cuentas por Cobrar</a>    </li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Reportes Generados
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Tablero</a></li> /
			<li class="active">Reportes Generados</li>
			</ul>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="17%"> Transaccion ID </th>
			<th width="8%"> Fecha </th>
			<th width="25%"> Nombre Cliente </th>
			<th width="25%"> Numero de Boleta </th>
