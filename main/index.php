...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
           <ul class="nav nav-list">
            <li class="active"><a href="#"><i class="icon-dashboard icon-2x"></i> Tablero</a></li> 
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Market Platea21</center></font>
<div id="mainmain">
...
<a href="supplier.php"><i class="icon-group icon-2x"></i><br> Proveedores</a>     
<a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i><br> Reporte de Ventas</a>
<a href="category.php"><i class="icon-list-alt icon-2x"></i><br> Categorias</a>
<a href="../index.php"><font color="red"><i class="icon-off icon-2x"></i></font><br> Salir</a> 
<?php
}
?>
