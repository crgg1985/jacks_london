...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="products.php"><i class="icon-list-alt icon-2x"></i> Productos</a>                                     </li>
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Volver</button></a>
			...
			<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Productos estan por debajo de 10 Und. 			</div>
</div>


<input type="text" style="padding:15px;" name="filter" value="" id="filter" placeholder="Buscar Producto..." autocomplete="off" />
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Agregar Productos</button></a><br><br>
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			...
			<th width="13%"> Categoria / Descripcion </th>
			<th width="7%"> Proveedor </th>
			<th width="9%"> Fecha Recibida </th>
			<th width="10%"> Fecha de Caducidad </th>
			<th width="6%"> Precio Original </th>
			<th width="6%"> Precio de Venta </th>
			<th width="6%"> Cantidad </th>
			<th width="5%"> Cantidad Restante</th>
			<th width="8%"> Total </th>
	...
	<tbody>
			...
			<a href="#" id="<?php echo $row['product_id']; ?>" class="delbutton" title="Click para borrar el producto"><button class="btn btn-danger"><i class="icon-trash"></i></button></a></td>
			</tr>
			<?php
				}
			?>
...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="supplier.php"><i class="icon-group icon-2x"></i> Proveedores</a>                                    </li>
			<li><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Reporte Ventas</a>                </li>
			<li><a href="category.php"><i class="icon-list-alt icon-2x"></i> Categorias</a>                                     </li>
