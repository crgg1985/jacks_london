...
<?php include('navfixed.php');?>
	...
	<div class="span2">
             <div class="well sidebar-nav">
              ...
              <li><a href="index.php"><i class="icon-dashboard icon-2x"></i> MENU PRINCIPAL </a></li> 
			...
			<li><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Reportes de venta</a>                </li>
			<li><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Inventario</a>                </li>
				<br><br><br><br><br><br>		
			<li>
	...
	<div class="span10">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Volver a Ventas</button></a>

<div class="content" id="content">
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	<div style="width: 100%; height: 190px;" >
	<div style="width: 900px; float: left;">
	<center><div style="font:bold 25px 'Aleo';">Comprobante de venta</div>
	Jacks Londo Floripa	<br>
	Dirección de Jacks London	<br>	<br>
	</center>
	<div>
	<?php
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		<thead>
			<tr>
				<th width="90"> Codigo Producto </th>
		...
		<tbody>
				...
				?>
				<tr>
					<td colspan="5"style=" text-align:right;"><strong style="font-size: 12px; color: #222222;">Efectivo cancelado:&nbsp;</strong></td>
