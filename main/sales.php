...
<?php //} ?>				
	...
	<div class="span10">
		<div class="contentheader">
			...
			<ul class="breadcrumb">
			<a href="index.php"><li>Tablero</li></a> /
...
<option></option>
	...
	?>
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_code']; ?> - <?php echo $row['gen_name']; ?> - <?php echo $row['product_name']; ?> | Expira : <?php echo $row['expiry_date']; ?></option>
	<?php
				}
			?>
</select>
