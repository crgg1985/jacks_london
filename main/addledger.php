...
<div id="ac">
<span>Cantidad: </span><input type="text" style="width:265px; height:30px;" name="amount" /><br>
<span>Observaciones : </span><input type="text" style="width:265px; height:30px;" name="remarks" /><br>
